...
Консольная утилита для пакетной и интерактивной работы с документами и изображениями.
...
## Установка
1. Склонировать репозиторий: `git clone https://github.com/whynotban/Office_Tweaks_v2.git`
